...
>
  ...
  Back
      ...
      <div className="absolute w-[600px] h-[600px] bg-primary 
                      rounded-full blur-2xl opacity-30 
                      animate-blob top-[-250px] right-[-250px]"></div>

      <div className="absolute w-[600px] h-[600px] bg-primary 
                      rounded-full blur-2xl opacity-30 
                      animate-blob animation-delay-2000 
                      bottom-[-250px] left-[-250px]"></div>
      ...
      <div className="relative z-10 bg-white w-full max-w-md p-10 rounded-2xl shadow-2xl border border-gray-100">
        ...
        <p className="text-gray-600 text-center mb-8">
          Login to access Smart GN digital services.
        </p>
